  ...
  const [chat, setChat] = useState([
    {
      role: 'assistant',
      content:
        'KAYA is ready as a proper chatbot. Choose Assistant, Search, or Trainer mode, then ask anything.',
    },
  ]);
  ...
  const sendMessage = async (text = message) => {
    ...
    try {
      ...
      setChat((items) => [
        ...
        {
          role: 'assistant',
          content: 'I could not reach the KAYA API. Start the backend, then try again.',
        },
      ]);
    } finally {
      setIsSending(false);
          ...
          <button
            ...
            onClick={() => {
              setChat([
                {
                  role: 'assistant',
                  content: 'New chat started. I will keep this as a separate training/session thread.',
                },
              ]);
              setSessionId('');
            }}
